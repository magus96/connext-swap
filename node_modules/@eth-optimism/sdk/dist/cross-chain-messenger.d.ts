...
import { L2OutputOracleParameters, BedrockOutputData, BedrockCrossChainMessageProof } from '@eth-optimism/core-utils';
import { CoreCrossChainMessage, OEContracts, OEContractsLike, MessageLike, MessageRequestLike, TransactionLike, AddressLike, NumberLike, SignerOrProviderLike, CrossChainMessage, CrossChainMessageRequest, CrossChainMessageProof, MessageDirection, MessageStatus, TokenBridgeMessage, MessageReceipt, BridgeAdapterData, BridgeAdapters, StateRoot, StateRootBatch, IBridgeAdapter } from './interfaces';
...
export declare class CrossChainMessenger {
    ...
    get l1Signer(): Signer;
    get l2Signer(): Signer;
    getL2OutputOracleParameters(): Promise<L2OutputOracleParameters>;
    ...
    getBedrockMessageProof(message: MessageLike): Promise<[
