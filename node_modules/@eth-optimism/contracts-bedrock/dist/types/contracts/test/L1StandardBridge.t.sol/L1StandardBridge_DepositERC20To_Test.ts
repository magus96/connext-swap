...
export interface L1StandardBridge_DepositERC20To_TestInterface
  ...
  functions: {
    ...
    "test_depositERC20To_success()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20To_success",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositERC20To_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_depositERC20To_success(overrides?: CallOverrides): Promise<void>;
