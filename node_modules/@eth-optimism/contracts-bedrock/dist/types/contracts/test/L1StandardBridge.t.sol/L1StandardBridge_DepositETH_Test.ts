...
export interface L1StandardBridge_DepositETH_TestInterface
  ...
  functions: {
    ...
    "test_depositETH_success()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositETH_success",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositETH_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositETH_TestInterface;
  ...
  callStatic: {
    ...
    test_depositETH_success(overrides?: CallOverrides): Promise<void>;
