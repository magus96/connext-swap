...
export interface L1StandardBridge_FinalizeBridgeETH_TestFailInterface
  ...
  functions: {
    ...
    "test_finalizeBridgeETH_revert_incorrectValue()": FunctionFragment;
    "test_finalizeBridgeETH_revert_sendToMessenger()": FunctionFragment;
    "test_finalizeBridgeETH_revert_sendToSelf()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_finalizeBridgeETH_revert_incorrectValue"
      | "test_finalizeBridgeETH_revert_sendToMessenger"
      | "test_finalizeBridgeETH_revert_sendToSelf"
      | "tip"
      | "vm"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_finalizeBridgeETH_revert_incorrectValue",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_finalizeBridgeETH_revert_sendToMessenger",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "test_finalizeBridgeETH_revert_sendToSelf",
    values?: undefined
  ): string;
  encodeFunctionData(
