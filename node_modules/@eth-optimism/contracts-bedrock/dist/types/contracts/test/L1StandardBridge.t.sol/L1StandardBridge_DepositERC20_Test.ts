...
export interface L1StandardBridge_DepositERC20_TestInterface
  ...
  functions: {
    ...
    "test_depositERC20_succeeds()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20_succeeds",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositERC20_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_DepositERC20_TestInterface;
  ...
  callStatic: {
    ...
    test_depositERC20_succeeds(overrides?: CallOverrides): Promise<void>;
