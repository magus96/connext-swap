...
export interface L1StandardBridge_DepositETH_TestFailInterface
  ...
  functions: {
    ...
    "test_DepositETH_revert_notEoa()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_DepositETH_revert_notEoa",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositETH_TestFail extends BaseContract {
  ...
  callStatic: {
    ...
    test_DepositETH_revert_notEoa(overrides?: CallOverrides): Promise<void>;
