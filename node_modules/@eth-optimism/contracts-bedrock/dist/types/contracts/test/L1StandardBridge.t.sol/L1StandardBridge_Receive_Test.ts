...
export interface L1StandardBridge_Receive_TestInterface
  ...
  functions: {
    ...
    "test_receive_success()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_receive_success",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_Receive_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: L1StandardBridge_Receive_TestInterface;
  ...
  callStatic: {
    ...
    test_receive_success(overrides?: CallOverrides): Promise<void>;
