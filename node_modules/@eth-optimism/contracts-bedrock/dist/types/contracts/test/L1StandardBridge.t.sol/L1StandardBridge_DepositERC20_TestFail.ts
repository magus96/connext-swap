...
export interface L1StandardBridge_DepositERC20_TestFailInterface
  ...
  functions: {
    ...
    "test_depositERC20_revert_notEoa()": FunctionFragment;
  ...
  getFunction(
    nameOrSignatureOrTopic:
      ...
      | "test_depositERC20_revert_notEoa"
      | "tip"
      | "vm"
      | "warpToProposeTime"
  ): FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_depositERC20_revert_notEoa",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_DepositERC20_TestFail extends BaseContract {
  ...
  callStatic: {
    ...
    test_depositERC20_revert_notEoa(overrides?: CallOverrides): Promise<void>;
