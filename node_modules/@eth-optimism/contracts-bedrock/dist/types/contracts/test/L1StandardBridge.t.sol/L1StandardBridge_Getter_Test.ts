...
export interface L1StandardBridge_Getter_TestInterface extends utils.Interface {
  functions: {
    ...
    "test_getters_success()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "test_getters_success",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface L1StandardBridge_Getter_Test extends BaseContract {
  ...
  callStatic: {
    ...
    test_getters_success(overrides?: CallOverrides): Promise<void>;
