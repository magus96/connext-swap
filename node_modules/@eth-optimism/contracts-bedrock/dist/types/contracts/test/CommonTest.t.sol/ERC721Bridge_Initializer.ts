...
export interface ERC721Bridge_InitializerInterface extends utils.Interface {
  functions: {
...
export interface ERC721Bridge_Initializer extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ERC721Bridge_InitializerInterface;
