...
export interface CrossDomainMessenger_TestInterface extends utils.Interface {
  functions: {
    ...
    "testFuzz_baseGas(uint32)": FunctionFragment;
    "test_baseGas()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "testFuzz_baseGas",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "test_baseGas",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface CrossDomainMessenger_Test extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CrossDomainMessenger_TestInterface;
  ...
  functions: {
    ...
    test_baseGas(overrides?: CallOverrides): Promise<[void]>;
  ...
  estimateGas: {
    ...
    test_baseGas(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    test_baseGas(overrides?: CallOverrides): Promise<PopulatedTransaction>;
