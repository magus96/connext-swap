...
exports.BIG_BALANCE = exports.getDeploymentAddress = exports.assertContractVariable = exports.isHardhatNode = exports.getContractFromArtifact = exports.sendImpersonatedTx = exports.fundAccount = exports.getAdvancedContract = exports.deployAndVerifyAndThen = void 0;
...
const deployAndVerifyAndThen = async ({ hre, name, args, contract, iface, postDeployAction, }) => {
    ...
    if (result.newlyDeployed) {
        if (!(await (0, exports.isHardhatNode)(hre)) && hre.network.config.live !== false) {
            try {
