...
var ExitUtil = /** @class */ (function () {
    ...
    ExitUtil.prototype.getExitProofFromAPI = function (burnHash, eventSignature) {
        var _this = this;
        return _services__WEBPACK_IMPORTED_MODULE_2__["service"].network.getExitProof(this.config.network, burnHash, eventSignature).then(function (exitProof) {
            if (!exitProof) {
                throw Error('Network API Error');
            }
...
var NetworkService = /** @class */ (function () {
    ...
    NetworkService.prototype.getExitProof = function (network, burnTxHash, eventSignature) {
        var url = this.createUrlForPos(network, "/exit-payload/".concat(burnTxHash, "?eventSignature=").concat(eventSignature));
        return this.httpRequest.get(url).then(function (result) {
...
var ERC20 = /** @class */ (function (_super) {
    ...
    ERC20.prototype.customERC20DepositClaim = function (transactionHash, option) {
        ...
        return this.parentBridge.networkID().then(function (networkId) {
            ...
            return _this.childBridge.claimMessage(payload.smtProof, payload.index, payload.mainnetExitRoot, payload.rollupExitRoot, payload.originNetwork, payload.originTokenAddress, payload.destinationNetwork, payload.destinationAddress, payload.amount, payload.metadata, option);
        });
    };
    /**
    ...
    ERC20.prototype.customERC20WithdrawExit = function (burnTransactionHash, option) {
        ...
        return this.childBridge.networkID().then(function (networkId) {
            ...
            return _this.parentBridge.claimMessage(payload.smtProof, payload.index, payload.mainnetExitRoot, payload.rollupExitRoot, payload.originNetwork, payload.originTokenAddress, payload.destinationNetwork, payload.destinationAddress, payload.amount, payload.metadata, option);
        });
    };
    /**
...
var ZkEvmBridge = /** @class */ (function (_super) {
     ...
     * @memberof ZkEvmBridge
     */
    ZkEvmBridge.prototype.claimMessage = function (smtProof, index, mainnetExitRoot, rollupExitRoot, originNetwork, originTokenAddress, destinationNetwork, destinationAddress, amount, metadata, option) {
        var _this = this;
        return this.method("claimMessage", smtProof, index, mainnetExitRoot, rollupExitRoot, originNetwork, originTokenAddress, destinationNetwork, destinationAddress, amount, metadata).then(function (method) {
            return _this.processWrite(method, option);
        });
    };
    /**
...
/*!******************************************!*\
  !*** ./src/zkevm/zkevm_custom_bridge.ts ***!
  \******************************************/
/*! exports provided: ZkEVMBridgeAdapter */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ZkEVMBridgeAdapter", function() { return ZkEVMBridgeAdapter; });
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils */ "./src/utils/index.ts");
var __extends = (undefined && undefined.__extends) || (function () {
    var extendStatics = function (d, b) {
        extendStatics = Object.setPrototypeOf ||
