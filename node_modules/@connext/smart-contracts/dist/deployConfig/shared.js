...
exports.MESSAGING_PROTOCOL_CONFIGS = exports.RELAYER_CONFIGS = exports.SPOKE_PREFIX = exports.HUB_PREFIX = exports.OPTIMISM_AMB = void 0;
const ethers_1 = require("ethers");
exports.OPTIMISM_AMB = {
    hub: {
...
exports.SPOKE_PREFIX = "Spoke";
const DEFAULT_PROCESS_GAS = ethers_1.BigNumber.from("850000");
const DEFAULT_RESERVE_GAS = ethers_1.BigNumber.from("15000");
const DEFAULT_DELAY_BLOCKS = 0;
exports.RELAYER_CONFIGS = {
    local: {
        1337: {
            relayerFeeVault: ethers_1.constants.AddressZero,
        },
        1338: {
            relayerFeeVault: ethers_1.constants.AddressZero,
        },
...
exports.MESSAGING_PROTOCOL_CONFIGS = {
    local: {
        hub: 1337,
        configs: {
            1337: {
                prefix: "Mainnet",
                ambs: {
                    hub: ethers_1.constants.AddressZero,
                    spoke: ethers_1.constants.AddressZero,
                },
            ...
            1338: {
                prefix: "Optimism",
                ambs: {
                    hub: exports.OPTIMISM_AMB.hub.address,
                    spoke: exports.OPTIMISM_AMB.spoke.address,
                },
                processGas: DEFAULT_PROCESS_GAS,
                reserveGas: DEFAULT_RESERVE_GAS,
                delayBlocks: DEFAULT_DELAY_BLOCKS,
            ...
            421613: {
                ...
                custom: {
                    hub: {
                        ...
                        maxSubmissionCostCap: ethers_1.utils.parseUnits("100000", "gwei"),
                        maxGasCap: DEFAULT_PROCESS_GAS,
                        gasPriceCap: ethers_1.utils.parseUnits("20", "gwei"), // minimum on arbitrum is 0.01 gwei
                    },
                },
            },
            80001: {
    ...
    mainnet: {
        ...
        configs: {
            ...
            10: {
                ...
                processGas: ethers_1.BigNumber.from("2000000"),
                reserveGas: DEFAULT_RESERVE_GAS,
                delayBlocks: DEFAULT_DELAY_BLOCKS,
                custom: {
                    hub: {
