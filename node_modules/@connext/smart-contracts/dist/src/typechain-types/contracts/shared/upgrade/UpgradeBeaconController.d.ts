...
export interface UpgradeBeaconControllerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "acceptProposedOwner" | "delay" | "owner" | "proposeNewOwner" | "proposed" | "proposedTimestamp" | "renounceOwnership" | "renounced" | "upgrade"): FunctionFragment;
...
export interface UpgradeBeaconController extends BaseContract {
    ...
    functions: {
        ...
        upgrade(_beacon: PromiseOrValue<string>, _implementation: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    acceptProposedOwner(overrides?: Overrides & {
    ...
    callStatic: {
        ...
        renounced(overrides?: CallOverrides): Promise<boolean>;
        upgrade(_beacon: PromiseOrValue<string>, _implementation: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "BeaconUpgraded(address,address)"(beacon?: PromiseOrValue<string> | null, implementation?: null): BeaconUpgradedEventFilter;
        BeaconUpgraded(beacon?: PromiseOrValue<string> | null, implementation?: null): BeaconUpgradedEventFilter;
...
//# sourceMappingURL=UpgradeBeaconController.d.ts.map