...
export interface SwapUtilsExternalInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getD" | "getY" | "getYD"): FunctionFragment;
    encodeFunctionData(functionFragment: "getD", values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "getY", values: [
    ...
    encodeFunctionData(functionFragment: "getYD", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>[],
        PromiseOrValue<BigNumberish>
...
export interface SwapUtilsExternal extends BaseContract {
    ...
    functions: {
        getD(xp: PromiseOrValue<BigNumberish>[], a: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
        getY(preciseA: PromiseOrValue<BigNumberish>, tokenIndexFrom: PromiseOrValue<BigNumberish>, tokenIndexTo: PromiseOrValue<BigNumberish>, x: PromiseOrValue<BigNumberish>, xp: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<[BigNumber]>;
        getYD(a: PromiseOrValue<BigNumberish>, tokenIndex: PromiseOrValue<BigNumberish>, xp: PromiseOrValue<BigNumberish>[], d: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
    };
    getD(xp: PromiseOrValue<BigNumberish>[], a: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    getY(preciseA: PromiseOrValue<BigNumberish>, tokenIndexFrom: PromiseOrValue<BigNumberish>, tokenIndexTo: PromiseOrValue<BigNumberish>, x: PromiseOrValue<BigNumberish>, xp: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
    getYD(a: PromiseOrValue<BigNumberish>, tokenIndex: PromiseOrValue<BigNumberish>, xp: PromiseOrValue<BigNumberish>[], d: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        getD(xp: PromiseOrValue<BigNumberish>[], a: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getY(preciseA: PromiseOrValue<BigNumberish>, tokenIndexFrom: PromiseOrValue<BigNumberish>, tokenIndexTo: PromiseOrValue<BigNumberish>, x: PromiseOrValue<BigNumberish>, xp: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getYD(a: PromiseOrValue<BigNumberish>, tokenIndex: PromiseOrValue<BigNumberish>, xp: PromiseOrValue<BigNumberish>[], d: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=SwapUtilsExternal.d.ts.map