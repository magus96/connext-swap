...
export interface ConstantsInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "AAVE_REFERRAL_CODE" | "A_PRECISION" | "BPS_FEE_DENOMINATOR" | "DEFAULT_COPY_BYTES" | "DEFAULT_DEADLINE_EXTENSION" | "DEFAULT_NORMALIZED_DECIMALS" | "EXECUTE_CALLDATA_RESERVE_GAS" | "FEE_DENOMINATOR" | "FUTURE_TIME_BUFFER" | "GOVERNANCE_DELAY" | "INITIAL_AAVE_REFERRAL_CODE" | "INITIAL_LIQUIDITY_FEE_NUMERATOR" | "INITIAL_MAX_ROUTERS" | "MAXIMUM_POOLED_TOKENS" | "MAX_A" | "MAX_ADMIN_FEE" | "MAX_A_CHANGE" | "MAX_LOOP_LIMIT" | "MAX_SWAP_FEE" | "MINIMUM_POOLED_TOKENS" | "MIN_RAMP_DELAY" | "MIN_RAMP_TIME" | "ORACLE_VALID_PERIOD" | "POOL_PRECISION_DECIMALS"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "BPS_FEE_DENOMINATOR", values?: undefined): string;
    encodeFunctionData(functionFragment: "DEFAULT_COPY_BYTES", values?: undefined): string;
    encodeFunctionData(functionFragment: "DEFAULT_DEADLINE_EXTENSION", values?: undefined): string;
    encodeFunctionData(functionFragment: "DEFAULT_NORMALIZED_DECIMALS", values?: undefined): string;
    encodeFunctionData(functionFragment: "EXECUTE_CALLDATA_RESERVE_GAS", values?: undefined): string;
    encodeFunctionData(functionFragment: "FEE_DENOMINATOR", values?: undefined): string;
    encodeFunctionData(functionFragment: "FUTURE_TIME_BUFFER", values?: undefined): string;
    encodeFunctionData(functionFragment: "GOVERNANCE_DELAY", values?: undefined): string;
    encodeFunctionData(functionFragment: "INITIAL_AAVE_REFERRAL_CODE", values?: undefined): string;
    encodeFunctionData(functionFragment: "INITIAL_LIQUIDITY_FEE_NUMERATOR", values?: undefined): string;
    encodeFunctionData(functionFragment: "INITIAL_MAX_ROUTERS", values?: undefined): string;
    encodeFunctionData(functionFragment: "MAXIMUM_POOLED_TOKENS", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "MAX_LOOP_LIMIT", values?: undefined): string;
    encodeFunctionData(functionFragment: "MAX_SWAP_FEE", values?: undefined): string;
    encodeFunctionData(functionFragment: "MINIMUM_POOLED_TOKENS", values?: undefined): string;
    encodeFunctionData(functionFragment: "MIN_RAMP_DELAY", values?: undefined): string;
    encodeFunctionData(functionFragment: "MIN_RAMP_TIME", values?: undefined): string;
    encodeFunctionData(functionFragment: "ORACLE_VALID_PERIOD", values?: undefined): string;
    ...
    decodeFunctionResult(functionFragment: "BPS_FEE_DENOMINATOR", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "DEFAULT_COPY_BYTES", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "DEFAULT_DEADLINE_EXTENSION", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "DEFAULT_NORMALIZED_DECIMALS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "EXECUTE_CALLDATA_RESERVE_GAS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "FEE_DENOMINATOR", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "FUTURE_TIME_BUFFER", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "GOVERNANCE_DELAY", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "INITIAL_AAVE_REFERRAL_CODE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "INITIAL_LIQUIDITY_FEE_NUMERATOR", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "INITIAL_MAX_ROUTERS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MAXIMUM_POOLED_TOKENS", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "MAX_LOOP_LIMIT", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MAX_SWAP_FEE", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MINIMUM_POOLED_TOKENS", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MIN_RAMP_DELAY", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MIN_RAMP_TIME", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "ORACLE_VALID_PERIOD", data: BytesLike): Result;
...
export interface Constants extends BaseContract {
    ...
    functions: {
        ...
        INITIAL_LIQUIDITY_FEE_NUMERATOR(overrides?: CallOverrides): Promise<[BigNumber]>;
    ...
    populateTransaction: {
        ...
        BPS_FEE_DENOMINATOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        DEFAULT_COPY_BYTES(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        DEFAULT_DEADLINE_EXTENSION(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        DEFAULT_NORMALIZED_DECIMALS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        EXECUTE_CALLDATA_RESERVE_GAS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        FEE_DENOMINATOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        FUTURE_TIME_BUFFER(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        GOVERNANCE_DELAY(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        INITIAL_AAVE_REFERRAL_CODE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        INITIAL_LIQUIDITY_FEE_NUMERATOR(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        INITIAL_MAX_ROUTERS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        MAXIMUM_POOLED_TOKENS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        MINIMUM_POOLED_TOKENS(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        ORACLE_VALID_PERIOD(overrides?: CallOverrides): Promise<PopulatedTransaction>;
