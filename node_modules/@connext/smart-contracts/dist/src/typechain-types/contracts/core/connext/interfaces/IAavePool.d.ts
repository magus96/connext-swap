...
export interface IAavePoolInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "backUnbacked" | "mintUnbacked" | "withdraw"): FunctionFragment;
...
export interface IAavePool extends BaseContract {
    ...
    callStatic: {
        backUnbacked(asset: PromiseOrValue<string>, amount: PromiseOrValue<BigNumberish>, fee: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
...
//# sourceMappingURL=IAavePool.d.ts.map