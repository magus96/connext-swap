...
export interface PriceOracleInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "getTokenPrice" | "isPriceOracle"): FunctionFragment;
...
export interface PriceOracle extends BaseContract {
    ...
    functions: {
        getTokenPrice(token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber, BigNumber]>;
