...
export interface IConnextInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "LIQUIDITY_FEE_DENOMINATOR" | "LIQUIDITY_FEE_NUMERATOR" | "aavePool" | "aavePortalFee" | "acceptProposedOwner" | "acceptProposedRouterOwner" | "addConnextion" | "addRelayer" | "addRouterLiquidity" | "addRouterLiquidityFor" | "addSequencer" | "addStableSwapPool" | "addSwapLiquidity" | "adoptedToCanonical" | "adoptedToLocalExternalPools((uint32,bytes32))" | "adoptedToLocalExternalPools(bytes32)" | "approveRouter" | "approveRouterForPortal" | "approvedAssets(bytes32)" | "approvedAssets((uint32,bytes32))" | "approvedRelayers" | "approvedSequencers" | "bumpTransfer" | "calculateRemoveSwapLiquidity" | "calculateRemoveSwapLiquidityOneToken" | "calculateSwap" | "calculateSwapTokenAmount" | "canonicalToAdopted(bytes32)" | "canonicalToAdopted((uint32,bytes32))" | "canonicalToRepresentation(bytes32)" | "canonicalToRepresentation((uint32,bytes32))" | "delay" | "diamondCut" | "domain" | "enrollCustom" | "enrollRemoteRouter" | "execute" | "facetAddress" | "facetAddresses" | "facetFunctionSelectors" | "facets" | "forceReceiveLocal" | "forceUpdateSlippage" | "getAavePortalDebt" | "getAavePortalFeeDebt" | "getAcceptanceTime" | "getCustodiedAmount" | "getLocalAndAdoptedToken" | "getProposedRouterOwner" | "getProposedRouterOwnerTimestamp" | "getRouterApproval" | "getRouterApprovalForPortal" | "getRouterOwner" | "getRouterRecipient" | "getSwapA" | "getSwapAPrecise" | "getSwapAdminBalance" | "getSwapLPToken" | "getSwapStorage" | "getSwapToken" | "getSwapTokenBalance" | "getSwapTokenIndex" | "getSwapVirtualPrice" | "getTokenId" | "handle" | "initializeRouter" | "initializeSwap" | "lpTokenTargetAddress" | "maxRoutersPerTransfer" | "nonce" | "owner" | "pause" | "paused" | "proposeDiamondCut" | "proposeNewOwner" | "proposeRouterAllowlistRemoval" | "proposeRouterOwner" | "proposed" | "proposedTimestamp" | "rampA" | "relayerFeeVault" | "remote" | "removeAssetId((uint32,bytes32),address,address)" | "removeAssetId(bytes32,address,address)" | "removeRelayer" | "removeRouterAllowlist" | "removeRouterLiquidity" | "removeRouterLiquidityFor" | "removeSequencer" | "removeSwapLiquidity" | "removeSwapLiquidityImbalance" | "removeSwapLiquidityOneToken" | "repayAavePortal" | "repayAavePortalFor" | "representationToCanonical" | "rescindDiamondCut" | "routedTransfers" | "routerAllowlistRemoved" | "routerAllowlistTimestamp" | "routerBalances" | "setAavePool" | "setAavePortalFee" | "setLiquidityFeeNumerator" | "setMaxRoutersPerTransfer" | "setRelayerFeeVault" | "setRouterRecipient" | "setSwapAdminFee" | "setSwapFee" | "setXAppConnectionManager" | "setupAsset" | "setupAssetWithDeployedRepresentation" | "stopRampA" | "swap" | "swapExact" | "swapExactOut" | "transferStatus" | "unapproveRouter" | "unapproveRouterForPortal" | "unpause" | "updateDetails" | "updateLiquidityCap" | "updateLpTokenTarget" | "withdrawSwapAdminFees" | "xAppConnectionManager" | "xcall" | "xcallIntoLocal"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "addConnextion", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    ...
    encodeFunctionData(functionFragment: "enrollCustom", values: [
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<string>
    ]): string;
    ...
    encodeFunctionData(functionFragment: "lpTokenTargetAddress", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "rampA", values: [
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>,
        PromiseOrValue<BigNumberish>
    ]): string;
    ...
    encodeFunctionData(functionFragment: "setSwapAdminFee", values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "setSwapFee", values: [PromiseOrValue<BytesLike>, PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "updateLpTokenTarget", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "lpTokenTargetAddress", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "updateLpTokenTarget", data: BytesLike): Result;
...
export interface IConnext extends BaseContract {
    ...
    functions: {
        ...
        acceptProposedRouterOwner(router: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        addConnextion(_domain: PromiseOrValue<BigNumberish>, _connext: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        addSwapLiquidity(canonicalId: PromiseOrValue<BytesLike>, amounts: PromiseOrValue<BigNumberish>[], minToMint: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        approveRouter(router: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        calculateRemoveSwapLiquidity(canonicalId: PromiseOrValue<BytesLike>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber[]]>;
        calculateRemoveSwapLiquidityOneToken(canonicalId: PromiseOrValue<BytesLike>, tokenAmount: PromiseOrValue<BigNumberish>, tokenIndex: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
        calculateSwap(canonicalId: PromiseOrValue<BytesLike>, tokenIndexFrom: PromiseOrValue<BigNumberish>, tokenIndexTo: PromiseOrValue<BigNumberish>, dx: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
        calculateSwapTokenAmount(canonicalId: PromiseOrValue<BytesLike>, amounts: PromiseOrValue<BigNumberish>[], deposit: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<[BigNumber]>;
        ...
        enrollCustom(_domain: PromiseOrValue<BigNumberish>, _id: PromiseOrValue<BytesLike>, _custom: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        getAcceptanceTime(_diamondCut: IDiamondCut.FacetCutStruct[], _init: PromiseOrValue<string>, _calldata: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        getSwapAdminBalance(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
        getSwapLPToken(canonicalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string]>;
        getSwapStorage(canonicalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[SwapUtils.SwapStructOutput]>;
        getSwapToken(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
        getSwapTokenBalance(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[BigNumber]>;
        getSwapTokenIndex(canonicalId: PromiseOrValue<BytesLike>, tokenAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[number]>;
        ...
        handle(_origin: PromiseOrValue<BigNumberish>, _nonce: PromiseOrValue<BigNumberish>, _sender: PromiseOrValue<BytesLike>, _message: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        initializeRouter(owner: PromiseOrValue<string>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        initializeSwap(_canonicalId: PromiseOrValue<BytesLike>, _pooledTokens: PromiseOrValue<string>[], decimals: PromiseOrValue<BigNumberish>[], lpTokenName: PromiseOrValue<string>, lpTokenSymbol: PromiseOrValue<string>, _a: PromiseOrValue<BigNumberish>, _fee: PromiseOrValue<BigNumberish>, _adminFee: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        proposeRouterOwner(router: PromiseOrValue<string>, proposed: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        proposed(overrides?: CallOverrides): Promise<[string]>;
        proposedTimestamp(overrides?: CallOverrides): Promise<[BigNumber]>;
        rampA(canonicalId: PromiseOrValue<BytesLike>, futureA: PromiseOrValue<BigNumberish>, futureTime: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        removeRouterLiquidity(_amount: PromiseOrValue<BigNumberish>, _local: PromiseOrValue<string>, _to: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        removeRouterLiquidityFor(_amount: PromiseOrValue<BigNumberish>, _local: PromiseOrValue<string>, _to: PromiseOrValue<string>, _router: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        removeSequencer(_sequencer: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        removeSwapLiquidity(canonicalId: PromiseOrValue<BytesLike>, amount: PromiseOrValue<BigNumberish>, minAmounts: PromiseOrValue<BigNumberish>[], deadline: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        removeSwapLiquidityImbalance(canonicalId: PromiseOrValue<BytesLike>, amounts: PromiseOrValue<BigNumberish>[], maxBurnAmount: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        removeSwapLiquidityOneToken(canonicalId: PromiseOrValue<BytesLike>, tokenAmount: PromiseOrValue<BigNumberish>, tokenIndex: PromiseOrValue<BigNumberish>, minAmount: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        repayAavePortalFor(_params: TransferInfoStruct, _backingAmount: PromiseOrValue<BigNumberish>, _feeAmount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        setRouterRecipient(router: PromiseOrValue<string>, recipient: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setSwapAdminFee(canonicalId: PromiseOrValue<BytesLike>, newAdminFee: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setSwapFee(canonicalId: PromiseOrValue<BytesLike>, newSwapFee: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        stopRampA(canonicalId: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swap(canonicalId: PromiseOrValue<BytesLike>, tokenIndexFrom: PromiseOrValue<BigNumberish>, tokenIndexTo: PromiseOrValue<BigNumberish>, dx: PromiseOrValue<BigNumberish>, minDy: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapExact(canonicalId: PromiseOrValue<BytesLike>, amountIn: PromiseOrValue<BigNumberish>, assetIn: PromiseOrValue<string>, assetOut: PromiseOrValue<string>, minAmountOut: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        swapExactOut(canonicalId: PromiseOrValue<BytesLike>, amountOut: PromiseOrValue<BigNumberish>, assetIn: PromiseOrValue<string>, assetOut: PromiseOrValue<string>, maxAmountIn: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        transferStatus(_transferId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[number]>;
        unapproveRouter(router: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        updateLpTokenTarget(newAddress: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        withdrawSwapAdminFees(canonicalId: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        addConnextion(_domain: PromiseOrValue<BigNumberish>, _connext: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        ...
        addSwapLiquidity(canonicalId: PromiseOrValue<BytesLike>, amounts: PromiseOrValue<BigNumberish>[], minToMint: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        adoptedToCanonical(_adopted: PromiseOrValue<string>, overrides?: CallOverrides): Promise<TokenIdStructOutput>;
        "adoptedToLocalExternalPools((uint32,bytes32))"(_canonical: TokenIdStruct, overrides?: CallOverrides): Promise<string>;
        "adoptedToLocalExternalPools(bytes32)"(_key: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
        ...
        domain(overrides?: CallOverrides): Promise<BigNumber>;
        enrollCustom(_domain: PromiseOrValue<BigNumberish>, _id: PromiseOrValue<BytesLike>, _custom: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        ...
        getSwapVirtualPrice(canonicalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        getTokenId(_candidate: PromiseOrValue<string>, overrides?: CallOverrides): Promise<TokenIdStructOutput>;
        handle(_origin: PromiseOrValue<BigNumberish>, _nonce: PromiseOrValue<BigNumberish>, _sender: PromiseOrValue<BytesLike>, _message: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        initializeRouter(owner: PromiseOrValue<string>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        initializeSwap(_canonicalId: PromiseOrValue<BytesLike>, _pooledTokens: PromiseOrValue<string>[], decimals: PromiseOrValue<BigNumberish>[], lpTokenName: PromiseOrValue<string>, lpTokenSymbol: PromiseOrValue<string>, _a: PromiseOrValue<BigNumberish>, _fee: PromiseOrValue<BigNumberish>, _adminFee: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        lpTokenTargetAddress(overrides?: CallOverrides): Promise<string>;
        maxRoutersPerTransfer(overrides?: CallOverrides): Promise<BigNumber>;
        nonce(overrides?: CallOverrides): Promise<BigNumber>;
        owner(overrides?: CallOverrides): Promise<string>;
        ...
        proposeRouterOwner(router: PromiseOrValue<string>, proposed: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        proposed(overrides?: CallOverrides): Promise<string>;
        proposedTimestamp(overrides?: CallOverrides): Promise<BigNumber>;
        rampA(canonicalId: PromiseOrValue<BytesLike>, futureA: PromiseOrValue<BigNumberish>, futureTime: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        relayerFeeVault(overrides?: CallOverrides): Promise<string>;
        remote(_domain: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        ...
        removeRouterLiquidity(_amount: PromiseOrValue<BigNumberish>, _local: PromiseOrValue<string>, _to: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        removeRouterLiquidityFor(_amount: PromiseOrValue<BigNumberish>, _local: PromiseOrValue<string>, _to: PromiseOrValue<string>, _router: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        removeSequencer(_sequencer: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        removeSwapLiquidity(canonicalId: PromiseOrValue<BytesLike>, amount: PromiseOrValue<BigNumberish>, minAmounts: PromiseOrValue<BigNumberish>[], deadline: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber[]>;
        removeSwapLiquidityImbalance(canonicalId: PromiseOrValue<BytesLike>, amounts: PromiseOrValue<BigNumberish>[], maxBurnAmount: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        removeSwapLiquidityOneToken(canonicalId: PromiseOrValue<BytesLike>, tokenAmount: PromiseOrValue<BigNumberish>, tokenIndex: PromiseOrValue<BigNumberish>, minAmount: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        repayAavePortalFor(_params: TransferInfoStruct, _backingAmount: PromiseOrValue<BigNumberish>, _feeAmount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        representationToCanonical(_adopted: PromiseOrValue<string>, overrides?: CallOverrides): Promise<TokenIdStructOutput>;
        ...
        setRouterRecipient(router: PromiseOrValue<string>, recipient: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        setSwapAdminFee(canonicalId: PromiseOrValue<BytesLike>, newAdminFee: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        setSwapFee(canonicalId: PromiseOrValue<BytesLike>, newSwapFee: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
        ...
        swap(canonicalId: PromiseOrValue<BytesLike>, tokenIndexFrom: PromiseOrValue<BigNumberish>, tokenIndexTo: PromiseOrValue<BigNumberish>, dx: PromiseOrValue<BigNumberish>, minDy: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        swapExact(canonicalId: PromiseOrValue<BytesLike>, amountIn: PromiseOrValue<BigNumberish>, assetIn: PromiseOrValue<string>, assetOut: PromiseOrValue<string>, minAmountOut: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        swapExactOut(canonicalId: PromiseOrValue<BytesLike>, amountOut: PromiseOrValue<BigNumberish>, assetIn: PromiseOrValue<string>, assetOut: PromiseOrValue<string>, maxAmountIn: PromiseOrValue<BigNumberish>, deadline: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        transferStatus(_transferId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<number>;
        ...
        updateLpTokenTarget(newAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        getSwapToken(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getSwapTokenBalance(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        getSwapTokenIndex(canonicalId: PromiseOrValue<BytesLike>, tokenAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        getSwapVirtualPrice(canonicalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        calculateRemoveSwapLiquidity(canonicalId: PromiseOrValue<BytesLike>, amount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculateRemoveSwapLiquidityOneToken(canonicalId: PromiseOrValue<BytesLike>, tokenAmount: PromiseOrValue<BigNumberish>, tokenIndex: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculateSwap(canonicalId: PromiseOrValue<BytesLike>, tokenIndexFrom: PromiseOrValue<BigNumberish>, tokenIndexTo: PromiseOrValue<BigNumberish>, dx: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        calculateSwapTokenAmount(canonicalId: PromiseOrValue<BytesLike>, amounts: PromiseOrValue<BigNumberish>[], deposit: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getSwapAdminBalance(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        getSwapToken(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getSwapTokenBalance(canonicalId: PromiseOrValue<BytesLike>, index: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getSwapTokenIndex(canonicalId: PromiseOrValue<BytesLike>, tokenAddress: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        getSwapVirtualPrice(canonicalId: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        lpTokenTargetAddress(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        representationToCanonical(_adopted: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        rescindDiamondCut(_diamondCut: IDiamondCut.FacetCutStruct[], _init: PromiseOrValue<string>, _calldata: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=IConnext.d.ts.map