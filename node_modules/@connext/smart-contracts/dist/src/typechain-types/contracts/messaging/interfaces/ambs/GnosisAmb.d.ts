...
export interface GnosisAmbInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "destinationChainId" | "executeSignatures" | "failedMessageDataHash" | "failedMessageReceiver" | "failedMessageSender" | "maxGasPerTx" | "messageCallStatus" | "messageId" | "messageSender" | "messageSourceChainId" | "requireToConfirmMessage" | "requireToGetInformation" | "requireToPassMessage" | "safeExecuteSignaturesWithAutoGasLimit" | "sourceChainId" | "transactionHash"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "requireToGetInformation", values: [PromiseOrValue<BytesLike>, PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "requireToPassMessage", values: [
        PromiseOrValue<string>,
        PromiseOrValue<BytesLike>,
        PromiseOrValue<BigNumberish>
    ]): string;
    encodeFunctionData(functionFragment: "safeExecuteSignaturesWithAutoGasLimit", values: [PromiseOrValue<BytesLike>, PromiseOrValue<BytesLike>]): string;
    ...
    decodeFunctionResult(functionFragment: "safeExecuteSignaturesWithAutoGasLimit", data: BytesLike): Result;
...
export interface GnosisAmb extends BaseContract {
    ...
    functions: {
        ...
        requireToGetInformation(_requestSelector: PromiseOrValue<BytesLike>, _data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        safeExecuteSignaturesWithAutoGasLimit(_data: PromiseOrValue<BytesLike>, _signatures: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        requireToGetInformation(_requestSelector: PromiseOrValue<BytesLike>, _data: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<string>;
        ...
        safeExecuteSignaturesWithAutoGasLimit(_data: PromiseOrValue<BytesLike>, _signatures: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        sourceChainId(overrides?: CallOverrides): Promise<BigNumber>;
        transactionHash(overrides?: CallOverrides): Promise<string>;
    };
    filters: {};
...
//# sourceMappingURL=GnosisAmb.d.ts.map