...
export interface IStateCommitmentChainInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "appendStateBatch" | "deleteStateBatch" | "getLastSequencerTimestamp" | "getTotalBatches" | "getTotalElements" | "insideFraudProofWindow" | "verifyStateCommitment"): FunctionFragment;
    encodeFunctionData(functionFragment: "appendStateBatch", values: [PromiseOrValue<BytesLike>[], PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "verifyStateCommitment", values: [
...
export type StateBatchAppendedEventFilter = TypedEventFilter<StateBatchAppendedEvent>;
...
export type StateBatchDeletedEventFilter = TypedEventFilter<StateBatchDeletedEvent>;
export interface IStateCommitmentChain extends BaseContract {
    ...
    functions: {
        appendStateBatch(_batch: PromiseOrValue<BytesLike>[], _shouldStartAtElement: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
        ...
        verifyStateCommitment(_element: PromiseOrValue<BytesLike>, _batchHeader: ChainBatchHeaderStruct, _proof: ChainInclusionProofStruct, overrides?: CallOverrides): Promise<[boolean] & {
            _verified: boolean;
        }>;
    };
    appendStateBatch(_batch: PromiseOrValue<BytesLike>[], _shouldStartAtElement: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
    ...
    verifyStateCommitment(_element: PromiseOrValue<BytesLike>, _batchHeader: ChainBatchHeaderStruct, _proof: ChainInclusionProofStruct, overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        appendStateBatch(_batch: PromiseOrValue<BytesLike>[], _shouldStartAtElement: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<void>;
    ...
    filters: {
        "StateBatchAppended(uint256,bytes32,uint256,uint256,bytes)"(_batchIndex?: PromiseOrValue<BigNumberish> | null, _batchRoot?: null, _batchSize?: null, _prevTotalElements?: null, _extraData?: null): StateBatchAppendedEventFilter;
        StateBatchAppended(_batchIndex?: PromiseOrValue<BigNumberish> | null, _batchRoot?: null, _batchSize?: null, _prevTotalElements?: null, _extraData?: null): StateBatchAppendedEventFilter;
        "StateBatchDeleted(uint256,bytes32)"(_batchIndex?: PromiseOrValue<BigNumberish> | null, _batchRoot?: null): StateBatchDeletedEventFilter;
        StateBatchDeleted(_batchIndex?: PromiseOrValue<BigNumberish> | null, _batchRoot?: null): StateBatchDeletedEventFilter;
    };
    estimateGas: {
        appendStateBatch(_batch: PromiseOrValue<BytesLike>[], _shouldStartAtElement: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        ...
        verifyStateCommitment(_element: PromiseOrValue<BytesLike>, _batchHeader: ChainBatchHeaderStruct, _proof: ChainInclusionProofStruct, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        appendStateBatch(_batch: PromiseOrValue<BytesLike>[], _shouldStartAtElement: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        ...
        verifyStateCommitment(_element: PromiseOrValue<BytesLike>, _batchHeader: ChainBatchHeaderStruct, _proof: ChainInclusionProofStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=IStateCommitmentChain.d.ts.map