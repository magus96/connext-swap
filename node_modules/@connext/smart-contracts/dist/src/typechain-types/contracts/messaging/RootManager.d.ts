...
export interface RootManagerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "DEQUEUE_MAX" | "MAX_DOMAINS" | "MERKLE" | "acceptProposedOwner" | "addConnector" | "aggregate" | "connectors" | "connectorsHash" | "delay" | "delayBlocks" | "dequeue" | "discardRoot" | "domains" | "domainsHash" | "getConnectorForDomain" | "getDomainIndex" | "getPendingInboundRootsCount" | "isDomainSupported" | "lastPropagatedRoot" | "owner" | "pause" | "paused" | "pendingInboundRoots" | "propagate" | "proposeNewOwner" | "proposed" | "proposedTimestamp" | "removeConnector" | "renounceOwnership" | "renounced" | "setDelayBlocks" | "setWatcherManager" | "unpause" | "validateConnectors" | "validateDomains" | "watcherManager"): FunctionFragment;
    encodeFunctionData(functionFragment: "DEQUEUE_MAX", values?: undefined): string;
    encodeFunctionData(functionFragment: "MAX_DOMAINS", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "addConnector", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "aggregate", values: [PromiseOrValue<BigNumberish>, PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: "discardRoot", values: [PromiseOrValue<BytesLike>]): string;
    ...
    encodeFunctionData(functionFragment: "lastPropagatedRoot", values?: undefined): string;
    ...
    encodeFunctionData(functionFragment: "validateDomains", values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<string>[]]): string;
    encodeFunctionData(functionFragment: "watcherManager", values?: undefined): string;
    decodeFunctionResult(functionFragment: "DEQUEUE_MAX", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "MAX_DOMAINS", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "discardRoot", data: BytesLike): Result;
    ...
    decodeFunctionResult(functionFragment: "lastPropagatedRoot", data: BytesLike): Result;
...
export interface RootManager extends BaseContract {
    ...
    functions: {
        ...
        addConnector(_domain: PromiseOrValue<BigNumberish>, _connector: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        aggregate(_domain: PromiseOrValue<BigNumberish>, _inbound: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        discardRoot(_root: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        pendingInboundRoots(overrides?: CallOverrides): Promise<[BigNumber, BigNumber] & {
            first: BigNumber;
            last: BigNumber;
        }>;
        propagate(_connectors: PromiseOrValue<string>[], _fees: PromiseOrValue<BigNumberish>[], _encodedData: PromiseOrValue<BytesLike>[], overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        removeConnector(_domain: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        setDelayBlocks(_delayBlocks: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setWatcherManager(_watcherManager: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        validateDomains(_domains: PromiseOrValue<BigNumberish>[], _connectors: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<[void]>;
    ...
    callStatic: {
        ...
        addConnector(_domain: PromiseOrValue<BigNumberish>, _connector: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        aggregate(_domain: PromiseOrValue<BigNumberish>, _inbound: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        connectors(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        connectorsHash(overrides?: CallOverrides): Promise<string>;
        delay(overrides?: CallOverrides): Promise<BigNumber>;
        delayBlocks(overrides?: CallOverrides): Promise<BigNumber>;
        dequeue(overrides?: CallOverrides): Promise<[string, BigNumber]>;
        discardRoot(_root: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<void>;
        domains(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<number>;
        domainsHash(overrides?: CallOverrides): Promise<string>;
        getConnectorForDomain(_domain: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        getDomainIndex(_domain: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    filters: {
        "ConnectorAdded(uint32,address,uint32[],address[])"(domain?: null, connector?: null, domains?: null, connectors?: null): ConnectorAddedEventFilter;
        ConnectorAdded(domain?: null, connector?: null, domains?: null, connectors?: null): ConnectorAddedEventFilter;
        "ConnectorRemoved(uint32,address,uint32[],address[],address)"(domain?: null, connector?: null, domains?: null, connectors?: null, caller?: null): ConnectorRemovedEventFilter;
        ConnectorRemoved(domain?: null, connector?: null, domains?: null, connectors?: null, caller?: null): ConnectorRemovedEventFilter;
        ...
        "DomainAdded(uint32,address)"(domain?: null, connector?: null): DomainAddedEventFilter;
        ...
        "PropagateFailed(uint32,address)"(domain?: null, connector?: null): PropagateFailedEventFilter;
        PropagateFailed(domain?: null, connector?: null): PropagateFailedEventFilter;
        ...
        "RootPropagated(bytes32,uint256,bytes32)"(aggregateRoot?: null, count?: null, domainsHash?: null): RootPropagatedEventFilter;
        RootPropagated(aggregateRoot?: null, count?: null, domainsHash?: null): RootPropagatedEventFilter;
        "RootReceived(uint32,bytes32,uint256)"(domain?: null, receivedRoot?: null, queueIndex?: null): RootReceivedEventFilter;
        RootReceived(domain?: null, receivedRoot?: null, queueIndex?: null): RootReceivedEventFilter;
        "RootsAggregated(bytes32,uint256,bytes32[])"(aggregateRoot?: null, count?: null, aggregatedMessageRoots?: null): RootsAggregatedEventFilter;
        RootsAggregated(aggregateRoot?: null, count?: null, aggregatedMessageRoots?: null): RootsAggregatedEventFilter;
    ...
    estimateGas: {
        ...
        validateDomains(_domains: PromiseOrValue<BigNumberish>[], _connectors: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        getConnectorForDomain(_domain: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        lastPropagatedRoot(overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        validateDomains(_domains: PromiseOrValue<BigNumberish>[], _connectors: PromiseOrValue<string>[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
        watcherManager(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=RootManager.d.ts.map