...
export interface MerkleTreeManagerInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "acceptProposedOwner" | "arborist" | "branch" | "count" | "delay" | "initialize" | "insert(bytes32)" | "insert(bytes32[])" | "owner" | "proposeNewOwner" | "proposed" | "proposedTimestamp" | "renounceOwnership" | "renounced" | "root" | "rootAndCount" | "setArborist" | "tree"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "insert(bytes32)", values: [PromiseOrValue<BytesLike>]): string;
    encodeFunctionData(functionFragment: "insert(bytes32[])", values: [PromiseOrValue<BytesLike>[]]): string;
    ...
    encodeFunctionData(functionFragment: "rootAndCount", values?: undefined): string;
    encodeFunctionData(functionFragment: "setArborist", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "rootAndCount", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "setArborist", data: BytesLike): Result;
...
export interface MerkleTreeManager extends BaseContract {
    ...
    functions: {
        ...
        initialize(_arborist: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "insert(bytes32)"(leaf: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        "insert(bytes32[])"(leaves: PromiseOrValue<BytesLike>[], overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        ...
        setArborist(newArborist: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        count(overrides?: CallOverrides): Promise<BigNumber>;
        delay(overrides?: CallOverrides): Promise<BigNumber>;
        initialize(_arborist: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        "insert(bytes32)"(leaf: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[string, BigNumber] & {
            _root: string;
            _count: BigNumber;
        }>;
        "insert(bytes32[])"(leaves: PromiseOrValue<BytesLike>[], overrides?: CallOverrides): Promise<[string, BigNumber] & {
            _root: string;
            _count: BigNumber;
        }>;
        owner(overrides?: CallOverrides): Promise<string>;
        ...
        root(overrides?: CallOverrides): Promise<string>;
        rootAndCount(overrides?: CallOverrides): Promise<[string, BigNumber]>;
        setArborist(newArborist: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        tree(overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
        "ArboristUpdated(address,address)"(previous?: null, updated?: null): ArboristUpdatedEventFilter;
        ArboristUpdated(previous?: null, updated?: null): ArboristUpdatedEventFilter;
        "Initialized(uint8)"(version?: null): InitializedEventFilter;
        Initialized(version?: null): InitializedEventFilter;
        "LeafInserted(bytes32,uint256,bytes32)"(root?: null, count?: null, leaf?: null): LeafInsertedEventFilter;
        LeafInserted(root?: null, count?: null, leaf?: null): LeafInsertedEventFilter;
        "LeavesInserted(bytes32,uint256,bytes32[])"(root?: null, count?: null, leaves?: null): LeavesInsertedEventFilter;
        LeavesInserted(root?: null, count?: null, leaves?: null): LeavesInsertedEventFilter;
...
//# sourceMappingURL=MerkleTreeManager.d.ts.map