...
export interface IFxStateSenderInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "sendMessageToChild", values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]): string;
...
export interface IFxStateSender extends BaseContract {
    ...
    functions: {
        sendMessageToChild(_receiver: PromiseOrValue<string>, _data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
...
//# sourceMappingURL=IFxStateSender.d.ts.map