...
export interface PolygonHubConnectorInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "AMB" | "DOMAIN" | "MIRROR_DOMAIN" | "ROOT_MANAGER" | "SEND_MESSAGE_EVENT_SIG" | "acceptProposedOwner" | "checkpointManager" | "delay" | "fxChildTunnel" | "fxRoot" | "mirrorConnector" | "owner" | "processMessage" | "processedExits" | "proposeNewOwner" | "proposed" | "proposedTimestamp" | "receiveMessage" | "renounceOwnership" | "renounced" | "sendMessage" | "setMirrorConnector" | "verifySender"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "receiveMessage", values: [PromiseOrValue<BytesLike>]): string;
...
export interface PolygonHubConnector extends BaseContract {
    ...
    functions: {
        ...
        receiveMessage(inputData: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
...
//# sourceMappingURL=PolygonHubConnector.d.ts.map