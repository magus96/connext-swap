...
export interface IArbitrumInboxInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "createRetryableTicket"): FunctionFragment;
...
export interface IArbitrumInbox extends BaseContract {
    ...
    functions: {
        createRetryableTicket(destAddr: PromiseOrValue<string>, arbTxCallValue: PromiseOrValue<BigNumberish>, maxSubmissionCost: PromiseOrValue<BigNumberish>, submissionRefundAddress: PromiseOrValue<string>, valueRefundAddress: PromiseOrValue<string>, maxGas: PromiseOrValue<BigNumberish>, gasPriceBid: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
...
//# sourceMappingURL=IArbitrumInbox.d.ts.map