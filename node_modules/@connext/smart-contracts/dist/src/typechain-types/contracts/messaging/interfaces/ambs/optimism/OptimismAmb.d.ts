...
export interface OptimismAmb extends BaseContract {
    ...
    functions: {
        sendMessage(_target: PromiseOrValue<string>, _message: PromiseOrValue<BytesLike>, _gasLimit: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
...
//# sourceMappingURL=OptimismAmb.d.ts.map