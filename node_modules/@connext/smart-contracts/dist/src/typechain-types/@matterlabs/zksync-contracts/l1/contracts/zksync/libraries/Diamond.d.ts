...
export interface Diamond extends BaseContract {
    ...
    callStatic: {};
    filters: {
        "DiamondCut(tuple[],address,bytes)"(facetCuts?: null, initAddress?: null, initCalldata?: null): DiamondCutEventFilter;
        DiamondCut(facetCuts?: null, initAddress?: null, initCalldata?: null): DiamondCutEventFilter;
    };
    estimateGas: {};
    populateTransaction: {};
}
