...
export declare namespace Plonk4VerifierWithAccessToDNext {
    type PartialVerifierStateStruct = {
    ...
    type PartialVerifierStateStructOutput = [
        PairingsBn254.FrStructOutput,
        PairingsBn254.FrStructOutput,
        PairingsBn254.FrStructOutput,
        PairingsBn254.FrStructOutput,
...
export interface VerifierInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "compute_powers_of_alpha" | "prepare_queries" | "rescue_custom_gate_linearization_contribution" | "verify_serialized_proof"): FunctionFragment;
    encodeFunctionData(functionFragment: "compute_powers_of_alpha", values: [Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct]): string;
    encodeFunctionData(functionFragment: "prepare_queries", values: [
    ...
    encodeFunctionData(functionFragment: "rescue_custom_gate_linearization_contribution", values: [
        VerificationKeyStruct,
        Plonk4VerifierWithAccessToDNext.ProofStruct,
        Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct
    ]): string;
    encodeFunctionData(functionFragment: "verify_serialized_proof", values: [PromiseOrValue<BigNumberish>[], PromiseOrValue<BigNumberish>[]]): string;
    decodeFunctionResult(functionFragment: "compute_powers_of_alpha", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "prepare_queries", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "rescue_custom_gate_linearization_contribution", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "verify_serialized_proof", data: BytesLike): Result;
    events: {};
}
export interface Verifier extends BaseContract {
    ...
    functions: {
        compute_powers_of_alpha(state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<[void]>;
        prepare_queries(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<[
            Plonk4VerifierWithAccessToDNext.QueriesStructOutput
        ] & {
            queries: Plonk4VerifierWithAccessToDNext.QueriesStructOutput;
        }>;
        rescue_custom_gate_linearization_contribution(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<[
            PairingsBn254.G1PointStructOutput
        ] & {
            result: PairingsBn254.G1PointStructOutput;
        }>;
        verify_serialized_proof(public_inputs: PromiseOrValue<BigNumberish>[], serialized_proof: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<[boolean]>;
    };
    compute_powers_of_alpha(state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<void>;
    prepare_queries(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<Plonk4VerifierWithAccessToDNext.QueriesStructOutput>;
    rescue_custom_gate_linearization_contribution(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<PairingsBn254.G1PointStructOutput>;
    verify_serialized_proof(public_inputs: PromiseOrValue<BigNumberish>[], serialized_proof: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<boolean>;
    callStatic: {
        compute_powers_of_alpha(state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<void>;
        prepare_queries(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<Plonk4VerifierWithAccessToDNext.QueriesStructOutput>;
    ...
    filters: {};
    estimateGas: {
        compute_powers_of_alpha(state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<BigNumber>;
        prepare_queries(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<BigNumber>;
        rescue_custom_gate_linearization_contribution(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<BigNumber>;
        verify_serialized_proof(public_inputs: PromiseOrValue<BigNumberish>[], serialized_proof: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        compute_powers_of_alpha(state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        prepare_queries(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        rescue_custom_gate_linearization_contribution(vk: VerificationKeyStruct, proof: Plonk4VerifierWithAccessToDNext.ProofStruct, state: Plonk4VerifierWithAccessToDNext.PartialVerifierStateStruct, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        verify_serialized_proof(public_inputs: PromiseOrValue<BigNumberish>[], serialized_proof: PromiseOrValue<BigNumberish>[], overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
