...
export interface IOutboxInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "OUTBOX_VERSION" | "bridge" | "calculateItemHash" | "calculateMerkleRoot" | "executeTransaction" | "executeTransactionSimulation" | "isSpent" | "l2ToL1Block" | "l2ToL1EthBlock" | "l2ToL1OutputId" | "l2ToL1Sender" | "l2ToL1Timestamp" | "rollup" | "roots" | "spent" | "updateSendRoot"): FunctionFragment;
