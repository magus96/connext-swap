...
export interface IBridgeInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "activeOutbox" | "allowedDelayedInboxList" | "allowedDelayedInboxes" | "allowedOutboxList" | "allowedOutboxes" | "delayedInboxAccs" | "delayedMessageCount" | "enqueueDelayedMessage" | "enqueueSequencerMessage" | "executeCall" | "initialize" | "rollup" | "sequencerInbox" | "sequencerInboxAccs" | "sequencerMessageCount" | "sequencerReportedSubMessageCount" | "setDelayedInbox" | "setOutbox" | "setSequencerInbox" | "submitBatchSpendingReport"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "allowedDelayedInboxes", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "allowedOutboxList", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "allowedOutboxes", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "delayedInboxAccs", values: [PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "delayedMessageCount", values?: undefined): string;
    encodeFunctionData(functionFragment: "enqueueDelayedMessage", values: [
    ...
    encodeFunctionData(functionFragment: "sequencerInboxAccs", values: [PromiseOrValue<BigNumberish>]): string;
    ...
    encodeFunctionData(functionFragment: "setDelayedInbox", values: [PromiseOrValue<string>, PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: "setOutbox", values: [PromiseOrValue<string>, PromiseOrValue<boolean>]): string;
    encodeFunctionData(functionFragment: "setSequencerInbox", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "submitBatchSpendingReport", values: [PromiseOrValue<string>, PromiseOrValue<BytesLike>]): string;
...
export interface IBridge extends BaseContract {
    ...
    functions: {
        ...
        allowedDelayedInboxList(arg0: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        allowedDelayedInboxes(inbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        allowedOutboxList(arg0: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        allowedOutboxes(outbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        delayedInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
        delayedMessageCount(overrides?: CallOverrides): Promise<[BigNumber]>;
        enqueueDelayedMessage(kind: PromiseOrValue<BigNumberish>, sender: PromiseOrValue<string>, messageDataHash: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        enqueueSequencerMessage(dataHash: PromiseOrValue<BytesLike>, afterDelayedMessagesRead: PromiseOrValue<BigNumberish>, prevMessageCount: PromiseOrValue<BigNumberish>, newMessageCount: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        executeCall(to: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        initialize(rollup_: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        rollup(overrides?: CallOverrides): Promise<[string]>;
        sequencerInbox(overrides?: CallOverrides): Promise<[string]>;
        sequencerInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string]>;
        ...
        setDelayedInbox(inbox: PromiseOrValue<string>, enabled: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setOutbox(inbox: PromiseOrValue<string>, enabled: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        setSequencerInbox(_sequencerInbox: PromiseOrValue<string>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        submitBatchSpendingReport(batchPoster: PromiseOrValue<string>, dataHash: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    };
    activeOutbox(overrides?: CallOverrides): Promise<string>;
    ...
    callStatic: {
        ...
        allowedDelayedInboxes(inbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        allowedOutboxList(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        allowedOutboxes(outbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<boolean>;
        delayedInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        delayedMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        enqueueDelayedMessage(kind: PromiseOrValue<BigNumberish>, sender: PromiseOrValue<string>, messageDataHash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
        enqueueSequencerMessage(dataHash: PromiseOrValue<BytesLike>, afterDelayedMessagesRead: PromiseOrValue<BigNumberish>, prevMessageCount: PromiseOrValue<BigNumberish>, newMessageCount: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            BigNumber,
            string,
            string,
            string
        ...
        executeCall(to: PromiseOrValue<string>, value: PromiseOrValue<BigNumberish>, data: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<[boolean, string] & {
            success: boolean;
            returnData: string;
        }>;
        initialize(rollup_: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        rollup(overrides?: CallOverrides): Promise<string>;
        sequencerInbox(overrides?: CallOverrides): Promise<string>;
        sequencerInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<string>;
        sequencerMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        sequencerReportedSubMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        setDelayedInbox(inbox: PromiseOrValue<string>, enabled: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        setOutbox(inbox: PromiseOrValue<string>, enabled: PromiseOrValue<boolean>, overrides?: CallOverrides): Promise<void>;
        setSequencerInbox(_sequencerInbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<void>;
        submitBatchSpendingReport(batchPoster: PromiseOrValue<string>, dataHash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<BigNumber>;
    };
    filters: {
        "BridgeCallTriggered(address,address,uint256,bytes)"(outbox?: PromiseOrValue<string> | null, to?: PromiseOrValue<string> | null, value?: null, data?: null): BridgeCallTriggeredEventFilter;
        BridgeCallTriggered(outbox?: PromiseOrValue<string> | null, to?: PromiseOrValue<string> | null, value?: null, data?: null): BridgeCallTriggeredEventFilter;
        "InboxToggle(address,bool)"(inbox?: PromiseOrValue<string> | null, enabled?: null): InboxToggleEventFilter;
        InboxToggle(inbox?: PromiseOrValue<string> | null, enabled?: null): InboxToggleEventFilter;
        "MessageDelivered(uint256,bytes32,address,uint8,address,bytes32,uint256,uint64)"(messageIndex?: PromiseOrValue<BigNumberish> | null, beforeInboxAcc?: PromiseOrValue<BytesLike> | null, inbox?: null, kind?: null, sender?: null, messageDataHash?: null, baseFeeL1?: null, timestamp?: null): MessageDeliveredEventFilter;
        MessageDelivered(messageIndex?: PromiseOrValue<BigNumberish> | null, beforeInboxAcc?: PromiseOrValue<BytesLike> | null, inbox?: null, kind?: null, sender?: null, messageDataHash?: null, baseFeeL1?: null, timestamp?: null): MessageDeliveredEventFilter;
        "OutboxToggle(address,bool)"(outbox?: PromiseOrValue<string> | null, enabled?: null): OutboxToggleEventFilter;
        OutboxToggle(outbox?: PromiseOrValue<string> | null, enabled?: null): OutboxToggleEventFilter;
    ...
    estimateGas: {
        ...
        allowedDelayedInboxes(inbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        allowedOutboxList(arg0: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        allowedOutboxes(outbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        delayedInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        delayedMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        enqueueDelayedMessage(kind: PromiseOrValue<BigNumberish>, sender: PromiseOrValue<string>, messageDataHash: PromiseOrValue<BytesLike>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
        ...
        sequencerInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        sequencerMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        sequencerReportedSubMessageCount(overrides?: CallOverrides): Promise<BigNumber>;
        setDelayedInbox(inbox: PromiseOrValue<string>, enabled: PromiseOrValue<boolean>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
    ...
    populateTransaction: {
        ...
        allowedDelayedInboxes(inbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        allowedOutboxList(arg0: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<PopulatedTransaction>;
        allowedOutboxes(outbox: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        delayedInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        sequencerInboxAccs(arg0: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
