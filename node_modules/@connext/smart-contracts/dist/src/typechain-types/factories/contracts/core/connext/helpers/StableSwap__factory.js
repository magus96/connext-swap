...
exports.StableSwap__factory = void 0;
...
class StableSwap__factory extends ethers_1.ContractFactory {
    ...
    static linkBytecode(linkLibraryAddresses) {
        ...
        linkedBytecode = linkedBytecode.replace(new RegExp("__\\$0399e8fdab399fb8f200f3895472e3787c\\$__", "g"), linkLibraryAddresses["contracts/core/connext/libraries/SwapUtilsExternal.sol:SwapUtilsExternal"]
            .replace(/^0x/, "")
            .toLowerCase());
...
exports.StableSwap__factory = StableSwap__factory;
StableSwap__factory.bytecode = _bytecode;
StableSwap__factory.abi = _abi;
//# sourceMappingURL=StableSwap__factory.js.map