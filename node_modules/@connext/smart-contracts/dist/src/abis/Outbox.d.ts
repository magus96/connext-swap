...
export interface OutboxInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "calculateItemHash", values: [string, string, BigNumberish, BigNumberish, BigNumberish, BigNumberish, BytesLike]): string;
    ...
    encodeFunctionData(functionFragment: "executeTransactionSimulation", values: [BigNumberish, string, string, BigNumberish, BigNumberish, BigNumberish, BigNumberish, BytesLike]): string;
...
export type SendRootUpdatedEvent = TypedEvent<[string, string], {
    blockHash: string;
    outputRoot: string;
}>;
