...
exports.MAINNET_PRODUCTION_INIT_CONFIG = void 0;
const ethers_1 = require("ethers");
exports.MAINNET_PRODUCTION_INIT_CONFIG = {
    hub: "6648936",
    supportedDomains: [
        "6648936",
        "1869640809",
    ...
    assets: [
        {
            ...
            canonical: {
                ...
                decimals: 6,
                cap: ethers_1.utils.parseUnits("10000000", 6).toString(),
            },
            representations: {
                "1869640809": {
        ...
        },
        {
            ...
            canonical: {
                ...
                decimals: 18,
                cap: ethers_1.utils.parseUnits("10000000", 18).toString(),
            },
            representations: {
                "1869640809": {
