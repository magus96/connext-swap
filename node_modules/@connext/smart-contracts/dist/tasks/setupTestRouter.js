...
exports.default = (0, config_1.task)("setup-test-router", "Add router and test assets")
    ...
    .setAction(async ({ assetId: _assetId, router, connextAddress: _connextAddress, amount: _amount, env: _env }, { deployments, getNamedAccounts, ethers, run }) => {
...
//# sourceMappingURL=setupTestRouter.js.map