...
exports.default = (0, config_1.task)("connector-send", "Call `Connector.send()` to distribute outbound root")
    .addOptionalParam("env", "Environment of contracts")
    .addOptionalParam("networkType", "Type of network of contracts")
    .setAction(async ({ env: _env, networkType: _networkType }, { deployments, ethers }) => {
